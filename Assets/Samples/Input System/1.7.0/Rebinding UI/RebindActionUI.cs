...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUI : MonoBehaviour
    {
        ...
        bool CheckForDuplicateBindings(InputAction action, int bindingIndex, bool allCompositeParts = false)
        {
            InputBinding newBinding = action.bindings[bindingIndex];
        ...
        [Tooltip("Optional bool field which allows you to OVERRIDE action lable with your own text")]
        public bool m_OverrideActionLable;

        [Tooltip("What text should be displayed  for the action lable?")]
        [SerializeField] string m_ActionLableText;
        ...
        private void UpdateActionLabel()
        {
            if (m_ActionLabel != null)
            {
                ...
                {
                    m_ActionLabel.text = m_ActionLableText;
                }
                else
                {
                    m_ActionLabel.text = action != null ? action.name : string.Empty;
                    m_ActionLableText = string.Empty;
                }
            }
        }
