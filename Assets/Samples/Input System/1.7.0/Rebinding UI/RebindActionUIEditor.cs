...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUIEditor : UnityEditor.Editor
    {
        ...
        protected void OnEnable()
        {
            ...
            m_ActionLableTextProperty = serializedObject.FindProperty("m_ActionLableText");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.Space();
            EditorGUILayout.LabelField(m_m_CustomizeUILable, Styles.boldLabel);
            using (new EditorGUI.IndentLevelScope())
            {
                EditorGUILayout.PropertyField(m_ActionOverrideProperty);

                if (m_RebindActionUI.m_OverrideActionLable)
                {
                    EditorGUILayout.PropertyField(m_ActionLableTextProperty);
                }
            }
        ...
        private SerializedProperty m_ActionLableTextProperty;
        ...
        private GUIContent m_m_CustomizeUILable = new GUIContent("Customize UI");
